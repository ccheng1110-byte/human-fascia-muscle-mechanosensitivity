...
- Eligible metadata samples: 11; mapped eligible samples: 11.
- Resolved gene column: Symbol.
- Frozen candidate coverage: 14/15.
- Core module gate: TRUE.
- Decision: **PARTIAL_PROCEED_WITH_MATRIX_GENE_COVERAGE_LIMIT**.

### GSE276045

- Matrix dimensions: 58096 x 179.
- Eligible metadata samples: 178; mapped eligible samples: 178.
- Resolved gene column: Genes.
- Frozen candidate coverage: 15/15.
- Core module gate: TRUE.
- Decision: **PASS_TO_S3_WI38_CELL_MODEL_STIFFNESS_ANALYSIS**.
