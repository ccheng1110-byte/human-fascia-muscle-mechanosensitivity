"""Build the style-polished DOCX from the v7 Markdown and Figures 1-6.
...
PROJECT = Path(r".")
INPUT_MD = PROJECT / (
    "results/11_manuscript_preparation/22B_style_polished_manuscript_v7.md"
)
...
OUTPUT_DIR = PROJECT / (
    "results/11_manuscript_preparation/22C_style_polished_word_manuscript"
)
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
OUTPUT_DOCX = OUTPUT_DIR / "22C_style_polished_manuscript_v7_with_figures.docx"
...
os.environ["MANUSCRIPT_HEADER"] = (
    "Human fascia–muscle mechanosensitivity | Style-polished manuscript"
)
os.environ["MANUSCRIPT_STATUS"] = (
    "Style-polished manuscript v7 | Evidence grade: CAUTION"
)
